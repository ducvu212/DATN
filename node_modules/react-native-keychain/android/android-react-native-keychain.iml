...
<module external.linked.project.id=":react-native-keychain" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android/app" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-keychain" />
  ...
  <component name="NewModuleRootManager">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.conceal:conceal:1.1.3@aar" level="project" />
